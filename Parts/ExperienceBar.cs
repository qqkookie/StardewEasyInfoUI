...
namespace EasyInfoUI
{
    internal class ExperienceBar : IDisposable
    {
        ...
        public void Dispose()
        {
            Events.Player.LevelChanged -= OnLevelChanged;
            Events.Display.RenderingHud -= OnRenderingHud;
            Events.Player.Warped -= OnWarped_RemoveAllExperiencePointDisplays;
            Events.GameLoop.UpdateTicked -= OnUpdateTicked_DetermineIfExperienceHasBeenGained;
            _timeToDisappear.Elapsed -= StopTimerAndFadeBarOut;
        ...
        internal void ToggleLevelUpAnimation(bool showLevelUpAnimation)
        {
        ...
        internal void ToggleExperienceBarFade(bool allowExperienceBarToFadeOut)
        {
            _allowExperienceBarToFadeOut = allowExperienceBarToFadeOut;
        }

        internal void ToggleShowExperienceGain(bool showExperienceGain)
        {
            Events.GameLoop.UpdateTicked -= OnUpdateTicked_DetermineIfExperienceHasBeenGained;
        ...
        internal void ToggleShowExperienceBar(bool showExperienceBar)
        {
            Events.GameLoop.UpdateTicked -= OnUpdateTicked_DetermineIfExperienceHasBeenGained;
            ...
            if (!Game1.eventUp)
            {
                if (_shouldDrawLevelUp)
                {
                    ...
                    Game1.drawWithBorder(
                        ModEntry.Translation.Get(LanguageKeys.LevelUp),
                        Color.DarkSlateGray,
                        Color.PaleTurquoise,
                        new Vector2(
