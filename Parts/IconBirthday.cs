    ...
    internal class IconBirthday : IDisposable
    {
        ...
        private void OnRenderedHud(object sender, RenderedHudEventArgs e)
        {
                ...
                (_birthdayIcon?.containsPoint(Game1.getMouseX(), Game1.getMouseY()) ?? false))
            {
                ...
                string hoverText = String.Format(Game1.content.LoadString("Strings\\UI:Billboard_Birthday"), _birthdayNPC.displayName);
